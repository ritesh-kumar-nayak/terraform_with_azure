variable "az_bastion_service_subnet_name" {
  default     = "AzureBastionSubnet"
  description = "Dedicated Subnet for Azure Bastion Service"
}
variable "az_bastion_service_address_prefixes" {
...
variable "az_bastion_service_public_ip" {
  default = "az-bastion-service-ip"
  type    = string

}
variable "az_bastion_service_name" {
  default = "az-bastion-service"
  type    = string
