...
sudo echo "Welcome to DevOps with Ritesh - WebVM App1 - VM Hostname: $(hostname)" > /var/www/html/webvm/hostname.html
sudo echo "Welcome to DevOps with Ritesh - WebVM App1 - App Status Page" > /var/www/html/webvm/status.html
